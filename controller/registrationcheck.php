...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!filter_var($email, FILTER_VALIDATE_EMAIL)) {//php standard library
    ...
    if ($password !== $retype_password) {
        echo json_encode(['success' => false, 'error' => 'Passwords do not match!']);//converting php array into json string
        exit;
    }

    // Password validation: at least 4 characters, at least one lowercase, one uppercase, and one digit

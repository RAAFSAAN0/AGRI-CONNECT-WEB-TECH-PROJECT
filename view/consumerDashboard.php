...
.mission-section {
    background-color:rgb(212, 212, 212); /* Greenish for Mission */
}

.vision-section {
    background-color:rgb(255, 255, 255); /* Dark Blueish for Vision */
}

.goals-section {
    background-color:rgb(192, 192, 192); /* Reddish Orange for Goals */
}
...
/* Alternating Order for Left and Right Layout */
